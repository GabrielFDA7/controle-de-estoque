...
public class PainelEntrada extends JPanel {
    ...
    public PainelEntrada() {
        ...
        // Título
        JLabel titulo = EstiloApp.criarTitulo("📥 Registro de Entrada de Mercadorias");
        titulo.setForeground(EstiloApp.VERDE);
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.gridwidth = 2;
        ...
        // Quantidade
        JLabel lblQtd = EstiloApp.criarLabel("Quantidade Entrada:");
        gbc.gridx = 0;
        gbc.gridy = 2;
        gbc.weightx = 0;
        add(lblQtd, gbc);
        ...
        JButton btnSalvar = EstiloApp.criarBotaoVerde("Registrar Entrada");
        btnSalvar.addActionListener(e -> registrarEntrada());
